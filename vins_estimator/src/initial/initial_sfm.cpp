...
//QUES:流程需要结合崔神的笔记阅读，不过现在没时间
/**
 * @description: 三角化两帧间某个对应特征点的深度
 * @param {type} 
 * @return: 
 */
...
/**
 * @description: PNP方法得到第l帧到第i帧的R_initial、P_initial
 * @param {type} 
 * @return: 
 */
...
/**
 * @description: 三角化frame0和frame1间所有对应点
 * @param {type} 
 * @return: 
 */
...
/**
 * @description: 纯视觉sfm，求解窗口中的所有图像帧的位姿和特征点坐标
